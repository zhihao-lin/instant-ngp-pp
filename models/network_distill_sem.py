...
class NGP_distill(nn.Module):
    def __init__(self, scale, rgb_act='Sigmoid', use_skybox=False, embed_a=False, embed_a_len=12, classes=7):
        ...
        self.xyz_encoder = \
            tcnn.NetworkWithInputEncoding(
                n_input_dims=3, n_output_dims=17,
                encoding_config={
                    "otype": "Grid",
	                "type": "Hash",
                    "n_levels": L,
        ...
        self.up_label_header = tcnn.Network(
        ...
        self.semantic_header = tcnn.Network(
                    n_input_dims=16, n_output_dims=classes,
                    network_config={
                        "otype": "CutlassMLP",
                        "activation": "ReLU",
                        "output_activation": "None",
    ...
    def forward(self, x, d, **kwargs):
        ...
        Outputs:
            ...
            rgbs: (N, 3)
        """
        sigmas, h, feat_rgb = self.density(x, return_feat=True)
        ...
        up_sem = self.up_label_header(h)
        semantic = self.semantic_header(h)
        ...
        return sigmas, rgbs, up_sem.reshape(-1), semantic
