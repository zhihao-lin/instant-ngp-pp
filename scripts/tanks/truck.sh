# python train.py --exp_name truck-no \
...
# python train.py --exp_name truck-smog --climate smog \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
#     --batch_size 1024 --scale 8.0 --num_epochs 140 --render_path --render_train --render_rgb \
#     --render_depth --embed_a --embed_a_len 6 --use_skybox \
#     --ckpt_load last.ckpt --val_only 

# python train.py --exp_name truck-flood --climate flood \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
#     --batch_size 1024 --scale 8.0 --num_epochs 140 --render_path --render_train --render_rgb \
#     --render_depth --embed_a --embed_a_len 6 --use_skybox \
#     --ckpt_load last.ckpt --val_only 
...
# Testing view
# python render.py --config configs/Truck.txt --exp_name truck-no \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
#     --batch_size 1024 --scale 8.0 --num_epochs 60 --render_path --render_rgb  --render_depth \
#     --embed_a --embed_a_len 8 --use_skybox \
#     --ckpt_load ckpts/tnt/truck-no/epoch=149_slim.ckpt 

# Smog
# python render.py --config configs/Truck.txt --exp_name truck-smog-sparse \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
#     --batch_size 1024 --scale 8.0 --num_epochs 60 --render_path --render_rgb \
#     --embed_a --embed_a_len 8 --use_skybox \
#     --ckpt_load ckpts/tnt/truck-no/epoch=149_slim.ckpt \
#     --depth_path results/tnt/truck-no/depth_raw.npy \
#     --simulate smog --depth_bound 0.9 --sigma 0.5 --rgb 0.925 0.906 0.758 

# Render panorama
# python render_panorama.py --config configs/Truck.txt --exp_name truck-no \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
...
python render.py --config configs/Truck.txt --exp_name truck-flood \
    --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt  \
    ...
    --plane_path ../datasets/TanksAndTempleBG/Truck/plane.npy \
    --gl_theta 0.008 --gl_sharpness 500 --wave_len 1.0 --wave_ampl 2000000 \
    --anti_aliasing_factor 1 --chunk_size 600000

# gan+ngp: smog
# python train.py --config configs/Truck.txt --exp_name truck-smog-gan-ngp \
#     --root_dir ../datasets/TanksAndTempleBG/Truck --dataset_name tnt \
